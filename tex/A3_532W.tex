...
\begin{document}
	...
	All the code can be found on: \url{https://github.com/n6graham/cpsc532_hw3}. Note: please copy paste URL into the browser, don't click on the link if it shows up as clickable in PDF.
	...
	All the code can be found on: https://github.com/n6graham/cpsc532\_hw2
