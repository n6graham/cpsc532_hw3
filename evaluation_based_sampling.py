...
def run_deterministic_tests():
    ...
    for i in range(1,14):
        ...
        ast = daphne(['desugar', '-i', '../HW3/programs/tests/deterministic/test_{}.daphne'.format(i)])
...
def run_probabilistic_tests():
    ...
    for i in range(1,7):
        ...
        ast = daphne(['desugar', '-i', '../HW3/programs/tests/probabilistic/test_{}.daphne'.format(i)])
